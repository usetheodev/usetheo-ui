/**
 * Pure validation core of FileDropzone — typed rejections, accept matching
 * (MIME exact / wildcard / extension), size and collective count rules.
 * Ported behaviors from the react-dropzone reference study (blueprint M5).
 */
