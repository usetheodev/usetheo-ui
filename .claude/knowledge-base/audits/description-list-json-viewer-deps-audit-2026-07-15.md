...
- `pnpm audit`: mesmas 5 advisories dev-chain (vite/esbuild via vitest) já registradas nos audits M0/M1 (followup #2) — nenhuma em dep declarada do plano; nenhuma mudança de manifest neste plano.
